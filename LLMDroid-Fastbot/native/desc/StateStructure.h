...
namespace fastbotx {
    ...
    private:
        ...
        */
        ...
        /**
         * Generate the description information of the Element.
         * Template:
         * A TextView with text "abc" and content description "abc"
         * which can click(0) or scroll(1)
         * The action part is generated by the generateElementInfo function
         * 
         * @param target 
         * @return std::string 
         */
        std::string generateElementInfo(const ElementPtr target, std::vector<ElementPtr>& elementToMerge, bool noChild, int& actionId);
